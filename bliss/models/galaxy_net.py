...
def conv_bn(in_channels, out_channels, stride=1):
    return nn.Sequential(
        Conv2d(in_channels, out_channels, kernel_size=3, padding=1, stride=stride),
...
class ResNetResidualBlock(ResidualBlock):
    def __init__(self, in_channels, out_channels, expansion=1, downsampling=1, conv=None, **kwargs):
